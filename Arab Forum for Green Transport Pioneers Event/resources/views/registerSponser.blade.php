...
@section('content')
  <div class="form-content">
    <div class="overlay"></div>
        <form action="{{url('newsponser')}}" class="first-form" method="post">
            @csrf
            {{-- @if ($errors->any)
        ...
        @endif --}}
            ...
            <div class="form-block">
                <input type="radio" value="مشارك فى المعرض" id="first-check" name="status">
                <label for="first-check" id="first-label">المشاركة في المعرض</label>
                <input type="radio" value="مشارك كراعي" id="second-check" name="status">
